...
import { CaretDownIcon, CloseIcon, EyeIcon, EyeOffIcon, NodeConnectionsLegendIcon, PinIconSvg, PinOutlineIcon, QueueStackIcon } from '@/components/icons';
      ...
      <div className="space-y-3 overflow-y-auto flex-1 pb-4">
        ...
        <div className="flex items-center gap-3 px-4 py-3 bg-white border border-gray-100 rounded-lg shadow-sm">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">Quick access to pinned parameter</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 px-4 py-3 bg-white border border-gray-100 rounded-lg shadow-sm">
          ...
          <div>
            <p className="text-sm font-medium text-gray-900">Pin widget</p>
