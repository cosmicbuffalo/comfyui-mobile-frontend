...
export function MobileWidgetModal({
  ...
  return createPortal(
    <div 
      className="fixed inset-0 z-[1500] bg-black/50 backdrop-blur-sm safe-area-top" 
      onClick={onClose}
    >
      {/* Modal Content */}
      <div 
        className="w-full h-full flex flex-col pt-safe-top"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header/Input Area - Pinned to Top */}
